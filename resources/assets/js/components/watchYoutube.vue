...
<div>
  <div id="logo">
    <h3 class="uk-display-inline uk-text-right uk-margin-small-right">
      FSOCIETY TV <i class="url uk-icon-justify uk-icon-users" style="margin-right:10px; margin-left:10px;"></i>{{totalListeners}}
    </h3>
    <h3 class="uk-display-inline uk-text-right uk-margin-small-right">
  ...
  <youtube id="player" v-if="key" type="text/html" class="youtube-player" :player-width="windowWidth" :player-height="windowHeight" :video-id="key" :player-vars="playerVars" @paused="pause" @ready="ready" @playing="playing" @ended="ended"></youtube>
