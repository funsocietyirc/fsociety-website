    ...
    <div class="show-episode">
        <div class="uk-grid">
            <div class="uk-width-1-1">
                <div class="episode-header uk-block uk-cover-background"
                     style="@if($episode->imageOriginal)background-image:url({!! $episode->imageOriginal !!}); @else background-image:url({!! asset('images/episodes/banner.png') !!});@endif">
                        ...
                        <div class="uk-block">
                            ...
                            <ul class="uk-subnav uk-subnav-line">
                                @foreach($episode->connections()->get() as $connection)
                                    <li>
                                        <a href="{{route('arg.show',$connection->argLink->slug)}}">{{$connection->argLink->name}}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
